      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/watchlists" className="text-sm font-medium text-gray-900">Watchlists</Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">Group objects you want to monitor together.</p>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 px-6 py-12 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">Create a watchlist to start tracking objects.</p>
          <button className="inline-flex items-center mt-4 bg-black text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors">
